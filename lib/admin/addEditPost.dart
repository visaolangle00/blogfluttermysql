...
class _AddEditPostState extends State<AddEditPost> {
  ...
  Future addEditPost()async{
    if(editMode){
      var uri = Uri.parse("http://192.168.1.10/flutter/blog_flutter/updatePost.php");
      ...
      var uri = Uri.parse("http://192.168.1.10/flutter/blog_flutter/addPost.php");
      var request = http.MultipartRequest("POST", uri);
      request.fields['title'] = title.text;
      request.fields['body']=body.text;
      request.fields['author']= widget.author;
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          editMode ? Container(child: Image.network('http://192.168.1.10/flutter/blog_flutter/uploads/${widget.postList[widget.index]['image']}'),
